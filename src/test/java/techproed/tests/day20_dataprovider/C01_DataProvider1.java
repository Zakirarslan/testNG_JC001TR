...
public class C01_DataProvider1 {
    /**
    ...
    public void test01(String email, String sifre,int x,boolean isValid){
        System.out.println("email: "+ email+", sifre: "+sifre+", yas: "+x+", durum: "+isValid);
